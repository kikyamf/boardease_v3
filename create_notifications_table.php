<?php
// Create notifications table in the boardease database
require_once 'dbConfig.php';

echo "Creating notifications table in boardease database...\n";
...
try {
    ...
    $test_notifications = [
        ...
        [1, 'Maintenance Alert', 'Scheduled maintenance for elevator tomorrow.', 'maintenance', 'unread'],
        [1, 'Important Announcement', 'Fire drill scheduled for next week.', 'announcement', 'unread']
    ];
