<?php
// Test the exact request that Android app sends
...
// Include the actual create_group_chat.php
try {
    include 'create_group_chat.php';
} catch (Exception $e) {
    echo "<p>❌ Error including create_group_chat.php: " . $e->getMessage() . "</p>";
}

$output = ob_get_clean();
echo "<h3>Response from create_group_chat.php:</h3>";
...
try {
    ...
    // Test the exact same operations as create_group_chat.php
    $group_name = 'Group 1';
    $created_by = 29;
    $members = [28, 1];
