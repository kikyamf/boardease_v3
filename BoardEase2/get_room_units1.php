...
try {
    ...
    // Fetch available room units for this bhr_id
    // Exclude room units that have active bookings (Pending or Confirmed status)
    // Include room units with no bookings or only Completed/Cancelled bookings
    $sql = "
        SELECT 
            ru.room_id,
            ru.bhr_id,
