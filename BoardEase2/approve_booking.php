<?php
// BoardEase2/approve_booking.php
// Script for BH Owners to approve a booking request on Live DB using mysqli
...
try {
    ...
    // Update booking status to 'Approved' and set approval_date
    $sql = "UPDATE bookings 
    ...
    if ($stmt->affected_rows > 0) {
        echo json_encode([
            'success' => true, 
            'message' => 'Booking approved successfully. The boarder has 3 days to pay.',
            'booking_id' => $bookingId
        ]);
        error_log("approve_booking.php - Booking ID $bookingId approved on live DB.");
    } else {
        echo json_encode([
            'success' => false, 
