<?php
// Get Bookings API - Returns all bookings for a user (owner or boarder)
...
try {
    ...
    if ($user_type === 'owner') {
        // Get bookings for owner (boarders who booked rooms in owner's boarding houses)
        $sql = "SELECT 
                    b.booking_id,
        ...
        // Get bookings for boarder (their own bookings)
        $sql = "SELECT 
                    b.booking_id,
                    b.user_id as boarder_id,
                    CONCAT(r.f_name, ' ', r.l_name) as boarder_name,
