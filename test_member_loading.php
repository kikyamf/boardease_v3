<?php
// Test member loading endpoint
error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "Testing Member Loading Endpoint...\n\n";

// Test the endpoint that CreateGroupChat is calling
$url = "http://192.168.101.6/BoardEase2/message/get_users_for_messaging.php?current_user_id=1";
echo "URL: " . $url . "\n";
