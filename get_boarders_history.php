...
try {
    // Get boarders history from bookings table
    // History includes 'Completed' bookings (rentals that have ended)
    $sql = "SELECT 
    ...
    echo json_encode([
        "success" => true,
        "boarders_history" => $boarders_history,
        "total_count" => count($boarders_history)
    ], JSON_UNESCAPED_SLASHES);
