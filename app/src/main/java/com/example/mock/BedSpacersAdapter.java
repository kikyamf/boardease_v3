...
public class BedSpacersAdapter extends RecyclerView.Adapter<BedSpacersAdapter.ViewHolder> {
    ...
    public BedSpacersAdapter(List<PrivateRoomsFragment.RoomData> roomList, 
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (room.imagePaths != null && !room.imagePaths.isEmpty()) {
            String imageUrl = "https://boardease.calapebohol.com/" + room.imagePaths.get(0);
            ...
            System.out.println("DEBUG: No images for bed spacer: " + room.title);
