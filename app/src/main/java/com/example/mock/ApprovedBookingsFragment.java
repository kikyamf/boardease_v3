...
public class ApprovedBookingsFragment extends Fragment {
    ...
    private void loadApprovedBookings(boolean isRefresh) {
        if (isRefresh) {
            ...
            // Show ProgressDialog on initial load - APPROVED BOOKINGS
        ...
        String url = "https://boardease.calapebohol.com/get_approved_bookings.php?user_id=" + userId + "&user_type=owner";
    ...
    private void updateUI() {
        if (approvedBookings == null || approvedBookings.isEmpty()) {
            ...
            if (emptyState != null) {
                ...
                emptyState.setText("No approved bookings yet");
            }
        } else {
            // Show recycler view
            if (recyclerView != null) {
