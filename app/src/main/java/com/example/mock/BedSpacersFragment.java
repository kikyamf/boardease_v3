...
public class BedSpacersFragment extends Fragment {
    ...
    private static final String GET_ROOMS_URL = "http://192.168.254.121/BoardEase2/get_rooms.php";
    private static final String DELETE_ROOM_URL = "http://192.168.254.121/BoardEase2/delete_room.php";
    private static final String GET_ROOM_UNITS_URL = "http://192.168.254.121/BoardEase2/get_room_units.php";
                    ...
                    try {
                        ...
                        if (jsonResponse.getBoolean("success")) {
                            ...
                            for (int i = 0; i < roomsArray.length(); i++) {
                                ...
                                // Only add bed spacers
                                String category = roomObj.getString("category");
                                System.out.println("DEBUG: Found room with category: '" + category + "'");
                                
                                if ("Bed Spacer".equals(category)) {
                                    PrivateRoomsFragment.RoomData room = new PrivateRoomsFragment.RoomData();
                                    ...
                                    roomList.add(room);
                                    System.out.println("DEBUG: Added bed spacer: " + room.title);
                                }
                            }
                            
                            adapter.notifyDataSetChanged();
                            System.out.println("DEBUG: Total bed spacers loaded: " + roomList.size());
    ...
    private void onRoomClick(PrivateRoomsFragment.RoomData room) {
        // Show room details dialog
        showRoomDetailsDialog(room);
    }

    private void onEditRoom(PrivateRoomsFragment.RoomData room) {
    ...
    private void onDeleteRoom(PrivateRoomsFragment.RoomData room) {
    ...
    private void showRoomDetailsDialog(PrivateRoomsFragment.RoomData room) {
