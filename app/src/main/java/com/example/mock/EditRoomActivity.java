...
public class EditRoomActivity extends AppCompatActivity {
    ...
    private void fetchRoomImages() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://boardease.calapebohol.com/get_rooms.php",
                response -> {
                    try {
                            ...
                            for (int i = 0; i < rooms.length(); i++) {
                                ...
                                if (room.getInt("bhr_id") == roomId) {
                                    ...
                                    for (int j = 0; j < images.length(); j++) {
                                        ...
                                        String fullImageUrl = "https://boardease.calapebohol.com/" + imagePath;
