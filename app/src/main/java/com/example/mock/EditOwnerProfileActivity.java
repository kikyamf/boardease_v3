...
public class EditOwnerProfileActivity extends AppCompatActivity {
    ...
    private static final String UPDATE_OWNER_PROFILE_URL = "http://192.168.254.121/BoardEase2/update_owner_profile.php";
    private static final String UPLOAD_PROFILE_PIC_URL = "http://192.168.254.121/BoardEase2/upload_profile_picture.php";
